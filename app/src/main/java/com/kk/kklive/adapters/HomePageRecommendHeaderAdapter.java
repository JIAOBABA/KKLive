 ...
 */
public class HomePageRecommendHeaderAdapter extends BaseAdapter implements StickyListHeadersAdapter, View.OnClickListener {

    private static final String TAG = HomePageRecommendHeaderAdapter.class.getSimpleName();
    ...
    public HomePageRecommendHeaderAdapter(Context context, List<Recommend.RoomListBean> data) {
