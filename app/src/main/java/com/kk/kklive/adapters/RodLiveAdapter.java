 ...
 */
public class RodLiveAdapter extends RecyclerView.Adapter<RodLiveAdapter.ViewHolder> implements View.OnClickListener {

    private List<RodLive.RoomListBean> data;
    ...
    public RodLiveAdapter(Context context, List<RodLive.RoomListBean> data){
    ...
    public void updateRes(List<RodLive.RoomListBean> data){
        if (data!=null) {
            this.data.clear();
    ...
    public void addRes(List<RodLive.RoomListBean> data){
        if (data!=null) {
            this.data.addAll(data);
            notifyDataSetChanged();
        }
    ...
    public RodLive.RoomListBean getItem(int position){
