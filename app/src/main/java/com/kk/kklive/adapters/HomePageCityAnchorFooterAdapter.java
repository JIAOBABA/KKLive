 ...
 */
public class HomePageCityAnchorFooterAdapter extends BaseAdapter implements StickyListHeadersAdapter, View.OnClickListener {

    private static final String TAG = HomePageCityAnchorFooterAdapter.class.getSimpleName();
    private List<CityAnchor.ActorNearbyBean> data;
    ...
    public HomePageCityAnchorFooterAdapter(Context context, List<CityAnchor.ActorNearbyBean> data) {
    ...
    public void updateRes(List<CityAnchor.ActorNearbyBean> data){
        if (data!=null) {
            this.data.clear();
    ...
    public void addRes(List<CityAnchor.ActorNearbyBean> data){
        if (data!=null) {
            this.data.addAll(data);
            notifyDataSetChanged();
        }
    ...
    @Override
    public CityAnchor.ActorNearbyBean getItem(int position) {
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_home_page_city_anchor_sticky_footer,parent,false);
            holder = new ViewHolder(convertView);
            convertView.setTag(holder);
        }else {
            holder = (ViewHolder) convertView.getTag();
    ...
    public void onClick(View v) {
        ...
        mListener.onFooterItemClick(position);
    }
    ...
    public interface OnItemClickListener{
        void onFooterItemClick(int position);
    }
}
